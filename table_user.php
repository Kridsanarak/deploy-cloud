...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        // สร้างคำสั่ง SQL เพื่อดึงข้อมูลเฉพาะเดือนปัจจุบันและเฉพาะ task ของ user_id ตัวเอง
        $currentMonth = date('m');
        $currentYear = date('Y');
        $sql = "SELECT 
            t.task_id,
        ...
        WHERE MONTH(t.start_date) = $currentMonth 
        AND YEAR(t.start_date) = $currentYear 
